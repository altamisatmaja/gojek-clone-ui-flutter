...
Color dark2 = const Color(0xFF4A4AdA);
...
TextStyle bold12_5 = regular12_5.copyWith(
    fontWeight: FontWeight.w700, fontSize: 16, letterSpacing: 0.1);
TextStyle bold14 = bold12_5.copyWith(fontSize: 18, letterSpacing: -0.5);
